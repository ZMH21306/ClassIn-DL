...
namespace VideoDownloader
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private readonly int _maxConcurrentDownloads = MAX_CONCURRENT_DOWNLOADS;
        private readonly SemaphoreSlim _downloadSemaphore = new SemaphoreSlim(MAX_CONCURRENT_DOWNLOADS);
