...
namespace VideoDownloader.ViewModels
{
    public sealed class DownloadManager : INotifyPropertyChanged, IDisposable
    {
        ...
        private int _maxDownloadThreads = 64;
        ...
        public int MaxDownloadThreads
        {
            ...
            set
            {
                if (SetField(ref _maxDownloadThreads, value))
                {
                    _downloadService.MaxDownloadThreads = value;
                }
            }
        }
        ...
        private void UpdateStatusSummary()
        {
            ...
            {
                ProgressValue = (double)_totalDownloadedBytes / _totalBytesToDownload * 100;
            }
        }
