...
namespace Classin视频解析下载工具.ViewModels
{
    public class SettingsViewModel : ViewModelBase
    {
        ...
        {
            get => _settings.MaxDownloadThreads;
            set
            {
                if (_settings.MaxDownloadThreads != value)
                {
        ...
        private void SaveSettings()
        {
            _configurationManager.UpdateConfiguration(c =>
            {
                ...
                c.MaxDownloadThreads = _settings.MaxDownloadThreads;
        ...
        public void ResetToDefaults()
        {
            _settings = new DownloadSettings
            {
                ...
                MaxDownloadThreads = AppConstants.MaxDownloadThreads,
            ...
            OnPropertyChanged(nameof(MaxDownloadThreads));
